...
private final Logger logger = LogManager.getLogger(this.getClass());
	...
	@PostMapping("/get-catagory-byid")
	public ResponseEntity<?> getCatagoryById(@RequestParam(name="catagoryId") Integer catagoryId) throws Exception  {
...
=======
	...
	public ResponseEntity<?> deleteProduct(@RequestParam(name="productId") String productId) {
		logger.info("deleteProduct starts:::" + productId);
		Map<String, Object> resp = new HashMap<>();

		try {
			resp = productService.deleteProduct(productId);
		} catch (Exception e) {
			e.printStackTrace();
		}
...
>>>>>>> Stashed changes
	...
	public ResponseEntity<?>  getSubCatagoryByCId(@PathVariable Integer cId) throws Exception  {
		
		Map<String, Object> resp = new HashMap<>();
		try {
			resp = productService.getSubCatagoryByCId(cId);
		} catch (Exception e) {
			e.printStackTrace();
		}
		logger.info("getAllProduct ends:::");
